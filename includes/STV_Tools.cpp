...
#ifndef STV_TOOLS_CPP
#define STV_TOOLS_CPP

#include <TMath.h>

#include "STV_Tools.hh"
...
STV_Tools::STV_Tools(TVector3 MuonVector,TVector3 ProtonVector, double MuonEnergy, double ProtonEnergy) {
	...
	double BE =0.02478; // 40Ar, GeV Using Same value as in CC_0Pion assuming the other constenst are the same //0.04; // GeV for Ar
