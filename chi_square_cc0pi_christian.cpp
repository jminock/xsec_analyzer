...
void Test_plot() {
  ...
  gStyle->SetOptStat(0);
    ...
    char RootName[1024];
  sprintf(text_title_pdf1, "Make_Plots_Annie_unimake_closure_0pi.pdf(","" );

  sprintf(text_title_pdf2, "Make_Plots_Annie_unimake_closure_0pi.pdf","" );
  sprintf(text_title_pdf3, "Make_Plots_Annie_unimake_closure_0pi.pdf)","" );
  sprintf(text_title_pdf4, "Make_Plots_Annie_unimake_closure_0pi","" );
...
//          integral += ac_matrix_bins->GetBinContent(iter_row + 1, iter_col + 1);
...
//      for ( int iter_col = 0; iter_col < nbins.size() - 1; ++iter_col ) {
//          ac_matrix_hist->SetBinContent(iter_row + 1, iter_col + 1, ac_matrix_bins->GetBinContent(iter_row + 1, iter_col + 1)/integral );
//      }
  } 
